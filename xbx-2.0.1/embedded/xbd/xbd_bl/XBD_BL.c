...
#define XBD_COMMAND_LEN (sizeof(XBDpfr)/sizeof(XBDpfr[0]) -1)
...
const char XBDvio[] CONSTDATAAREA = "XBD"XBD_PROTO_VERSION"BLo";
...
const char XBDunk[] CONSTDATAAREA = "XBD"XBD_PROTO_VERSION"unk";
//CRC wrong response
const char XBDcrc[] CONSTDATAAREA = "XBD"XBD_PROTO_VERSION"crc";
...
uint8_t sw_flashbuffer[PAGESIZE];
...
void XBD_BL_HandleVersionInformationRequest(){
	XBD_loadStringFromConstDataArea((char *)XBD_response, XBDvio);
	realTXlen=XBD_COMMAND_LEN+CRC16SIZE;
}
